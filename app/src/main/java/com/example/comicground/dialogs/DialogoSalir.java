...
public class DialogoSalir {
    ...
    public static AlertDialog crearDialogoSalir(Context contexto) {
        ...
        builder.setTitle(R.string.app_name)
                ...
                .setNegativeButton(R.string.dialogExitNegative, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
                        dialogInterface.dismiss();
                    }
                })
                .setPositiveButton(R.string.dialogExitPositive, new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialogInterface, int i) {
